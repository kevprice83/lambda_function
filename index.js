...
var webhookID = 'T025GE0MG/B0DGYQWK1/1D8tVhME0eapoS9XW0mBOLz2';
...
exports.handler = function(event, context) {
        try {
          ...
          var slashCommandToken = params.command === "/answer" ? 'EIMDzZWFqrSWHfIx1kz3bqUV' : 'Ob0mvDGCxkeS2P8Evu0QqLs1';
          ...
          var webhookText = "nice try!" + " " + params.user_name + " " + "you have been ninja'd...move this talk to another channel.";

          var webhookTextAnswer = "A: " + pickAnAnswer();

          var webhookTextQuestion = "Q: " + pickAQuestion();
